...
public class AdminController {
	...
	@PostMapping("/login")
	public ApiResponse adminLogin(HttpServletRequest request,@RequestBody @Valid LoginDTO loginDTO,BindingResult result) {
	...
	@PostMapping("/save")
	public ApiResponse saveOrUpdate(HttpServletRequest request,@RequestBody @Valid AdminDTO adminDTO,BindingResult result) {
	...
	public ApiResponse updateJurisdiction(HttpServletRequest request,@RequestBody @Valid EditJurisdictionDTO editJurisdictionDTO,BindingResult result) {
	...
	public ApiResponse addCompany(HttpServletRequest request,@RequestBody @Valid AddCompanyDTO addCompanyDTO,BindingResult result) {
	...
	public ApiResponse updateCompany(HttpServletRequest request,@RequestBody @Valid CompanyDTO companyDTO,BindingResult result) {
	...
	public ApiResponse saveOrUpdatePosition(HttpServletRequest request,@RequestBody @Valid PositionDTO positionDTO,BindingResult result) {
	...
	public ApiResponse resumeList(HttpServletRequest request,@RequestBody ResumeSearchDTO resumeSearchDTO,Long page,Integer size) {
	...
	public ApiResponse interviewInvitation(HttpServletRequest request,@RequestBody @Valid AddInterviewDTO addInterviewDTO,BindingResult result) {
