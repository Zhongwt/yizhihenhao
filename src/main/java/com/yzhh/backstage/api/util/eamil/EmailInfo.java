...
public class EmailInfo {
	...
	private String smtpServer = "smtp.yizhihenhao.com"; 	// SMTP服务器地址
	private String port = "465"; // 端口
	private String fromUserName = "postmaster@yizhihenhao.com"; // 登录SMTP服务器的用户名,发送人邮箱地址
	private String fromUserPassword = "Yzhh123yzhh"; // 登录SMTP服务器的密码
